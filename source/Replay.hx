...
class Replay
{
	...
	public function SaveReplay(notearray:Array<Dynamic>, judge:Array<String>, ana:Analysis)
	{
		...
		#if sys
		File.saveContent("assets/replays/replay-" + PlayState.SONG.song + "-time" + time + ".ZincReplay", data);

		path = "replay-" + PlayState.SONG.song + "-time" + time + ".ZincReplay"; // for score screen shit
