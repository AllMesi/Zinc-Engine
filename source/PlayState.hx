...
class PlayState extends MusicBeatState
{
	...
	public static var health_stat:Float = 1; 
	...
	override public function create()
	{
		...
		trace('"`FlxCamera.defaultCameras` is deprecated, use `FlxG.cameras.setDefaultDrawTarget` instead" - FlxCamera.defaultCameras = [camGame]; 2021');
		...
		ZincEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + CoolUtil.difficultyFromInt(storyDifficulty), 16);
		ZincEngineWatermark.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE,FlxColor.BLACK);
		ZincEngineWatermark.scrollFactor.set();
		add(ZincEngineWatermark);
	...
	override public function update(elapsed:Float)
	{
		...
		scoreTxt.text = Ratings.CalculateRanking(songScore,songScoreDef,nps,maxNPS,health_stat,accuracy);
