...
- Title now shows "Friday Night Funkin' Zinc Engine"
- **THIS UPDATE WILL RESET YOUR SAVE FOR Zinc Engine**, so you gotta redo all of ur settings.

### Added
- Lua Modchart support [(documentation located here)](https://github.com/ZincDev/Zinc-Engine/blob/master/ModCharts.md)
- New option called watermarks which removes all watermarks from Zinc Engine
...
- Zinc Engine Watermark not showing on all charts.
