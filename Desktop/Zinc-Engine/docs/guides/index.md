...
### Contributing
If you'd like to write a guide, you can make a [pull request](https://github.com/ZincDev/Zinc-Engine/pulls). Make sure you put the guide in `docs/guides/` and that it's written in Markdown.
