...
class PlayState extends MusicBeatState
{
	...
	var ZincEngineWatermark:FlxText;
	...
	public static var health_:Float = 1;
	public var health__:Int = 0;
	...
	override public function create()
	{
		...
		// Add Zinc Engine watermark
		// " - "
		ZincEngineWatermark = new FlxText(4, healthBarBG.y
			+ 50, 0,
			SONG.song
			+ " "
			+ CoolUtil.difficultyFromInt(storyDifficulty)
			+ "\n" + (Main.watermarks), 16);
		ZincEngineWatermark.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.BLACK, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.WHITE);
		ZincEngineWatermark.scrollFactor.set();

		if (PlayStateChangeables.useDownscroll)
			ZincEngineWatermark.y = FlxG.height * 0.9 + 45;
		...
		scoreTxt.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.BLACK, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.WHITE);
		...
		ZincEngineWatermark.cameras = [camHUD];
		if (loadRep)
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...4)
		{
			...
			{
				babyArrow.loadGraphic(Paths.image('ghost/NOTE_assets'), true, 17, 17);
	...
	override public function update(elapsed:Float)
	{
		...
		if (executeModchart && luaModchart != null && songStarted)
		{
			...
			if (luaModchart.getVar("showOnlyStrums", 'bool'))
			{
				...
				ZincEngineWatermark.visible = false;
			...
			else
			{
				...
				ZincEngineWatermark.visible = true;
		...
		scoreTxt.text =	Ratings.CalculateRanking(songScore, songScoreDef, nps, maxNPS, accuracy) + " || " + "Health: " + Math.round(health * 50) + "%"; 
