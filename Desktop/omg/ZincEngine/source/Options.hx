...
class NewInput extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.ghost ? "New Input True" : "New Input False";
	}
}
...
class StepManiaOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "Colors by quantization " + (!FlxG.save.data.stepMania ? "false" : "true");
	}
}
...
class AntialiasingOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "Antialiasing " + (!FlxG.save.data.antialiasing ? "false" : "true");
	}
}
...
class MissSoundsOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "Miss Sounds " + (!FlxG.save.data.missSounds ? "false" : "true");
	}
}
