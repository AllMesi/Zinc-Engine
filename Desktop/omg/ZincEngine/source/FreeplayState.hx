...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		totalText.setFormat(Paths.font("vcr.ttf"), 24, FlxColor.WHITE, CENTER);
		add(totalText);
...
//		hcText = new FlxText(FlxG.width * 0.85, FlxG.height - 50 , 0, "", 24);
//		hcText.setFormat(Paths.font("vcr.ttf"), 27, FlxColor.BLACK, RIGHT, OUTLINE, FlxColor.WHITE);
//		add(hcText)
	...
	override function update(elapsed:Float)
	{
		...
		scoreText.text = "PB:" + lerpScore;
		comboText.text = combo;
		totalText.text = curSelected + 1 + " / " + songs.length + " Songs";
		// hcText.text = "HC:" + PlayState.highestCombo 
