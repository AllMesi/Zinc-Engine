...
class MainMenuState extends MusicBeatState
{
	...
	public static var ZincEngineVer:String = "1.2" + nightly;
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(10, FlxG.height - 50, 0,  (Main.watermarks ? "FNF " + gameVer + " || Zinc Engine " + ZincEngineVer : ""), 12);
