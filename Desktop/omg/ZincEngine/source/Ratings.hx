...
class Ratings
{
    ...
    public static function CalculateRanking(score:Int,scoreDef:Int,nps:Int,maxNPS:Int,accuracy:Float):String
    {
        return
         ...
         "NPS: " + nps + " (" + maxNPS + ") || " + (!PlayStateChangeables.botPlay || PlayState.loadRep ? "" : "") : "") +								// 	NPS
         ...
         " || Accuracy: " + (PlayStateChangeables.botPlay && !PlayState.loadRep ? "Nothing" : HelperFunctions.truncateFloat(accuracy, 2) + "%") +  				// 	Accuracy
         " || HC: " + PlayState.highestCombo +
