...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		new OptionCategory("Gameplay", [
			...
			new NewInput("Toggle counting pressing a directional input when no arrow is there as a miss."),
		...
		new OptionCategory("Saves and Data", [
			...
			new OptionCategory("Test",[new BotPlay("Showcase your charts and mods with autoplay.")])
